...
namespace Optano.Algorithm.Tuner.Application
{
    ...
    /// </summary>
    internal class TimeMeasuringExecutorFactory
        : ITargetAlgorithmFactory<TimeMeasuringExecutor, InstanceFile, RuntimeResult>
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeMeasuringExecutorFactory"/> class.
        /// </summary>
        ...
        public TimeMeasuringExecutorFactory(string basicCommand, TimeSpan timeout)
        {
        ...
        /// </returns>
        public TimeMeasuringExecutor ConfigureTargetAlgorithm(Dictionary<string, IAllele> parameters)
        {
            return new TimeMeasuringExecutor(parameters, this._basicCommand, this._timeout);
        }
