...
namespace Optano.Algorithm.Tuner.Lingeling
{
    ...
    /// </summary>
    public class LingelingRunnerConfigurationParser : HelpSupportingArgumentParser<LingelingRunnerConfiguration.LingelingConfigBuilder>
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LingelingRunnerConfigurationParser"/> class.
        /// </summary>
        public LingelingRunnerConfigurationParser()
