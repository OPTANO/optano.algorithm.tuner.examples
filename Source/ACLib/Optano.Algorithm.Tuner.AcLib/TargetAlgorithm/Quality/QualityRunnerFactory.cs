...
namespace Optano.Algorithm.Tuner.AcLib.TargetAlgorithm.Quality
{
    ...
    /// <summary>
    /// Creates <see cref="QualityRunner"/>s.
    /// </summary>
    internal class QualityRunnerFactory : RunnerFactoryBase<QualityRunner, ContinuousResult>
    {
        ...
        /// <summary>
        /// Creates a <see cref="QualityRunner" /> configured by the specified parameters.
        /// </summary>
        ...
        /// </returns>
        protected override QualityRunner CreateTargetAlgorithm(Dictionary<string, IAllele> activeParameters)
        {
            return new QualityRunner(this.Scenario, activeParameters);
        }
