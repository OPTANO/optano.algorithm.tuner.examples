...
namespace Optano.Algorithm.Tuner.Bbob
{
    ...
    public class BbobRunner : ITargetAlgorithm<InstanceFile, ContinuousResult>
    {
        ...
        public BbobRunner(int functionId, Dictionary<string, IAllele> parameters, string pythonBin, string pathToScript)
        {
            ...
            {
                throw new FileNotFoundException("You need to provide bbobbenchmarks.py next to your BBOB python script. For further information please consult the documentation at https://docs.optano.com/algorithmtuner/current/userDoc/bbob.html.");
            }
